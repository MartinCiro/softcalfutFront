...
export default defineConfig({
  ...
  preview: {
    ...
    allowedHosts: true,
    origin: process.env.VITE_ALLOWED_ORIGINS || process.env.__VITE_ADDITIONAL_PREVIEW_ALLOWED_HOSTS || 'http://softcalfut_front:4173,https://www.softcalfut.duckdns.org',
    headers: {
  ...
  server: {
    ...
    strictPort: false,
    allowedHosts: true,
    origin: process.env.VITE_ALLOWED_ORIGINS || 'http://softcalfut_front:4173,https://www.softcalfut.duckdns.org',
    hmr: {
      protocol: 'wss',
